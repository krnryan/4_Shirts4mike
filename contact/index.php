...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($error_message)) {
        ...
        $address = "ryan.mingyu.choi@gmail.com";
            ...
            <form method="post" action="<?php echo BASE_URL; ?>contact/">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <select>
                                <option value="account" id="reason">Account</option>
                                <option value="billing" id="reason">Billing</option>
                                <option value="shipping" id="reason">Shipping</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
